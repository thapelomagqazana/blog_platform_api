...
SECRET_KEY = 'django-insecure-864k15t@%+l@cl0l7@7duc7(i9!_znxaen==rnmrinx3-9(2-z'
...
AUTH_USER_MODEL = 'blog.CustomUser'  # Use the custom user model
...
AUTHENTICATION_BACKENDS = [
    'blog.backends.EmailAuthBackend',  # Custom backend
